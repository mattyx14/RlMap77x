function onUse(cid, item, frompos, item2, topos)
	...
	if item.uid == 10014 and item.itemid == 1945 and getgate1.itemid == 1304 and getgate2.itemid == 1304
		and getgate3.itemid == 1304 and getgate4.itemid == 1304 and getgate5.itemid == 1304 then
	...
	elseif item.uid == 10014 and item.itemid == 1946 and getgate1.itemid == 0 and getgate2.itemid == 0
		and getgate3.itemid == 0 and getgate4.itemid == 0 and getgate5.itemid == 0 then
