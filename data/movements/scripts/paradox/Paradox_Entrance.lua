function onStepIn(cid, item, pos)
	...
	if item.actionid == 8006 and getskull1.itemid == 2229 and getskull2.itemid == 2229 and getskull3.itemid == 2229 and getskull4.itemid == 2229 then
