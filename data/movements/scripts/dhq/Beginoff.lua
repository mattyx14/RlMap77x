function onStepOut(cid, item, frompos, item2, topos) 
	...
	if item.uid == 9025 and
		getwall1.itemid == 0 and
		getwall2.itemid == 0 and
		getwall3.itemid == 0 then
...
function onStepIn(cid, item, frompos, item2, topos)
	...
	if item.uid == 9025 and gettile1.itemid == 425 and
		getwall1.itemid == 1050 and
		getwall2.itemid == 1050 and
		getwall3.itemid == 1050 then
		doTransformItem(item.uid, item.itemid - 1)
