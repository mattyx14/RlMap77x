...
local gettile2 = getThingfromPos(tile2pos)
	...
	if gettile.itemid == 425 and
	gettile.itemid == 425 then
	doRemoveItem(getwall.uid,1)
	doRemoveItem(getwall1.uid,1)
	doRemoveItem(getwall2.uid,1)
	doPlayerSendTextMessage(cid,18,"You moved the wall.")
	elseif gettile.itemid == 426 and
	gettile.itemid == 426 and
	getwall.itemid == 0   and
	getwall1.itemid == 0   and
	getwall2.itemid == 0   then
