...
#include "definitions.h"
	...
	#define ID_MENU_RELOAD_RAIDS 507
	#define ID_MENU_RELOAD_SPELLS 508
	#define ID_MENU_RELOAD_STAGES 509
	#define ID_MENU_RELOAD_TALKACTIONS 510
	#define ID_MENU_RELOAD_MODS 511
	#ifdef __LOGIN_SERVER__
	#define ID_MENU_RELOAD_GAMESERVERS 512
	#endif
